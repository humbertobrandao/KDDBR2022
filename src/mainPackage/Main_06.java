...
public class Main_06 {
    ...
    public static void main(String[] args) {
        ...
        for (String set : sets) {
            ...
            HashMap<String, ArrayList<Direction_v_06>> results = new HashMap<>();
            ...
            //String folderStr  = "/home/humberto/" + set + "/";
            ...
            files.parallelStream().forEach(file -> {
                ...
                ArrayList<Direction_v_06> directions = new ArrayList<>();
                
                System.out.println(set + "\tStarting " + fileName + "...");
                ...
                try {
                    ...
                    double bestLinearCorrelation = 0;
                    ...
                    for (int x : xs) {
                        for (int y : ys) {
                            ...
                            bestLinearCorrelation = Double.MIN_VALUE;
                            ...
                            for (int i = (x - (w / 2)); i <= (x + (w / 2)); i++) {
                                for (int j = (y - (h / 2)); j <= (y + (h / 2)); j++) {
                                    ...
                                    double currentCorrelation = Statistics.linearCorrelation(vetLeft, vetRight);
                                    if (currentCorrelation > bestLinearCorrelation) {
                                        bestLinearCorrelation = currentCorrelation;
                                        bestDeltaW = i;
                                        bestDeltaH = j;
                                    //System.out.println("BEST = d(" + (x - bestDeltaW) + "," + (y - bestDeltaH) + ") = " + bestLinearCorrelation);
                                    }
                                }
                            }

//                        System.out.println();
                            Direction_v_06 vector = new Direction_v_06((x - bestDeltaW), (y - bestDeltaH), bestLinearCorrelation);
                            directions.add(vector);
                            //System.out.println(bestLinearCorrelation);
...
//                        System.out.println("----");
            ...
            ArrayList<Direction_v_06> tmp = results.get(tmpKey);
            output.append("\"file\",");
            ...
            for (String key : results.keySet()) {
                ArrayList<Direction_v_06> directions = results.get(key);
                System.out.print(key + ",");
                output.append(key).append(",");
                for (int i = 0; i < directions.size(); i++) {
                    Direction_v_06 direction = directions.get(i);
            ...
            try {
                ...
                Logger.getLogger(Main_06.class.getName()).log(Level.SEVERE, null, ex);
            }
