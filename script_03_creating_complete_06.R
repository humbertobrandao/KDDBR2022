...
# This script summarize statistically data, which we create using Main_06 in 
...
auxTrain <- fread("./aux_06_train.csv");
auxTest <- fread("./aux_06_test.csv");
...
names(aux) <- paste("base_06_",names(aux),sep="");
names(aux)[1] <- "Filename";

fwrite(aux, "./complete_06.csv");
